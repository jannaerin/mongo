...
private:
    ...
    struct collAndChunkTask {
        ...
        // Used by the CollAndChunkTaskTaskList below to enforce consistent updates are applied.
        ...
        // Used by the CollAndChunkTaskTaskListTaskList below to enforce consistent updates are
        // applied.
    ...
    /**
     * This represents an update task for the persisted db version. The task will either be to
    ...
    struct dbTask {
         ...
         * Initializes a task for either dropping or updating the persisted metadata for the
         * associated
         * database. Which type of task is determined by the Status of 'swDatabaseType', whether it
         * is
         * NamespaceNotFound or OK.
         *
         * Note: swDatabaseType must always be NamespaceNotFound or OK, otherwise the constructor
         * will
         * invariant because there is no task to complete.
         *
        ...
        // db version update to be applied to the shard persisted metadata store.
        ...
        // Either the highest chunk version in 'databaseType' or the same as
    ...
    typedef std::map<StringData, DbTaskList> DbTaskLists;
